...
public class QuickSettingsController {
    ...
    void loadTiles() {
        ...
        for (String tile : tiles.split("\\|")) {
            ...
            } else if (tile.contains(TILE_SPIRIT)) {
                qs = new SpiritControlsTile(mContext, this);
            }
  ...
  /*      QuickSettingsTile qs = new DockBatteryTile(mContext, this, mStatusBarService.mDockBatteryController);
    ...
    protected void setupQuickSettings() {
        ...
        if (mRibbonMode) {
            ...
            int tileTextColor = Settings.System.getInt(resolver,
                    Settings.System.QUICK_TILES_TEXT_COLOR, -2);
            for (QuickSettingsTile t : mQuickSettingsTiles) {
                t.setColors(bgColor, presColor, tileTextColor);
            }
        }
    }
