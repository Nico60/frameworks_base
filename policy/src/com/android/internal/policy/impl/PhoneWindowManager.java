...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void updateSettings() {
        ...
        if (NavHeight != mUserNavBarHeight || NavHeightLand != mUserNavBarHeightLand
                || NavWidth != mUserNavBarWidth || currentWants != mWantsNavigationBar) {
    ...
    BusyDialog mBootMsgDialog = null;
        ...
        mHandler.post(new Runnable() {
            @Override public void run() {
                if (mBootMsgDialog == null) {
                    mBootMsgDialog = new BusyDialog(mContext, android.R.style.Theme_Translucent_NoTitleBar);
